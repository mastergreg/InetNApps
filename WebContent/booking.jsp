...
<body>
	<%
		...
		Cookie c2 = new Cookie("price", "" + Integer.parseInt(people)
				* getPrice(dest));
	...
	%>
	<h2>Press OK if you accept or cancel otherwise</h2>
	<table>
		<tr>
			<td>Cost:</td>
			<td><%=Integer.parseInt(people) * getPrice(dest)%></td>
		</tr>
		<tr>
			<td><form method="post" action="final.jsp">
					<input type="submit" value="OK">
				</form></td>
			<td><form method="post" action="continent.jsp">
